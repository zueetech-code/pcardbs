...
const [npaData, setNpaData] = useState<NPAData>({
  ...
  useEffect(() => {
  async function init() {
    const res = await fetch("/api/me") // create this
...
const handleGetData = async () => {
  ...
  try {
    ...
    setColumnOrders({
      branch: deriveColumnOrder(report.branch),
      member: deriveColumnOrder(report.member),
      deposit: deriveColumnOrder(report.deposit),
      loan: deriveColumnOrder(report.loan),
      jewel: deriveColumnOrder(report.jewel)
    })
